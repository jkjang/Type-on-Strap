        ...
        <div className="w-100">
          ...
          <div className="resume-item d-flex flex-column flex-md-row justify-content-between mb-5">
            <div className="resume-content">
              ...
              <p>
                총 4개월간 1인 개발을 하게 되었으며, 시간이 촉박했지만 게임을 오픈하는데 일조하였음.
              </p>
              <ul>
                <li>아레나M 운영툴 개발</li>
                <li>진행 기간 : 2018.9 ~ 2018.12</li>
                <li>멤버 : 1명(1인 개발)</li>
                <li>개발 내용</li>
                <ul>
                  <li>운영툴</li>
                  <ul>
                    <li>
                      이벤트 관리, 토너먼트 관리, 키워드 쿠폰 관리, 랜덤 쿠폰 관리, 접속 보상, 친구
                      초대 이벤트, 계정 관리, 결제 조회, 토너먼트 조회, 동시접속자 관리, 아이템
                      발송, 게임중 우편, 점검중 우편, 메시지 발송, 인게임 롤링 공지, 광고성 푸시,
                      기획 테이블
                    </li>
                  </ul>
                  <li>통계툴</li>
                  <ul>
                    <li>
                      대시보드, 기본 지표, KPI, 잔존율, 인앱결제 상품, 마켓별 매출, 게임 지표,
                      재화량 통계, BJ 통계, 플레이 통계, 시간대별 통계
                    </li>
                  </ul>
                  <li>점검툴</li>
                  <ul>
                    <li>점검 관리, 앱 버전 관리, 동시접속자 관리</li>
                  </ul>
                </ul>
                <li>개발 환경</li>
                <ul>
                  ...
                  <li>DATABASE</li>
                  <ul>
                    <li>MYSQL : Game DATABASE, User DATABASE</li>
                    <li>Redis : Pub Sub으로 게임서버와 통신하여 점검. </li>
                  </ul>
                  <li>Web Server</li>
                  <ul>
                    <li>NGINX : STATIC ASSET</li>
                  </ul>
                </ul>
              </ul>
            </div>
